...
REGISTRY_FILE = SWARM_DIR / "delegable_tasks.json"
        ...
        "cost_tracker_persistence": [
            {
                ...
                "params": {
                    ...
                    "field_name": "cost_tracker_enabled",
                    "field_value": "true",
                    "comment": "# cost_tracker_persistence: 是否启用 SQLite 持久化成本跟踪",
                },
                "expected_outcome": "config.yaml 新增 cost_tracker_enabled 字段",
            },
            {
                "task_type": "add_import",
                "params": {
                    "file": "self_evolve_round.py",
                    "import_stmt": "import sqlite3",
                    "position": "after:import json",
                },
        ...
        "heartbeat_self_healing": [
            {
                ...
                "params": {
                    "file": "config.yaml",
                    "section": "swarm",
                    "field_name": "self_healing_enabled",
                    "field_value": "true",
                    "comment": "# heartbeat_self_healing: 失联 Agent 自动重启",
                },
                "expected_outcome": "config.yaml 新增 self_healing_enabled 字段",
            },
        ],
        "metrics_sqlite_storage": [
            ...
            },
            {
                ...
                "params": {
                    "file": "config.yaml",
                    "section": "delegation_incentive",
                    "field_name": "metrics_sqlite_path",
                    "field_value": "\"logs/metrics.db\"",
                    "comment": "# metrics_sqlite_storage: SQLite 存储路径",
                },
                "expected_outcome": "config.yaml 新增 metrics_sqlite_path 字段",
            },
        ],
        "git_autopush_safety": [
            {
                ...
                "params": {
                    "file": "config.yaml",
                    "section": "git",
                    "field_name": "auto_push",
                    "field_value": "true",
                    "comment": "# git_autopush_safety: commit 后自动 push（含重试）",
                },
                "expected_outcome": "config.yaml 新增 auto_push 字段",
            },
        ],
        "json_logs_startup_flag": [
            {
                ...
                "params": {
                    ...
                    "field_value": "false",
                    "comment": "# json_logs_startup_flag: --json-logs 参数开启时切换为 JSON 格式",
                },
                "expected_outcome": "config.yaml 新增 json_mode 字段",
            },
        ],
        "delegation_validation_loop": [
            {
                ...
                "params": {
                    "file": "config.yaml",
                    "section": "delegation_incentive",
                    "field_name": "validation_threshold_delegate_rate",
                    "field_value": "0.3",
                    "comment": "# delegation_validation_loop: 每轮委托率阈值（低于此值触发警报）",
                },
                "expected_outcome": "config.yaml 新增 validation_threshold_delegate_rate 字段",
            },
        ],
    }
    ...
    if predefined:
        ...
        for pd in predefined:
            result.append({
                ...
                "verify_command": f"grep -q '{pd['params'].get('field_name', pd['params'].get('import_stmt', 'micro'))}' "
